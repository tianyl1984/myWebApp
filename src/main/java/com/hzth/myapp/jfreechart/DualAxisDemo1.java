...
public class DualAxisDemo1 extends ApplicationFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 20820314253270255L;
	...
	private static CategoryDataset createDataset3() {
		...
		String s8 = "Category 8";
		DefaultCategoryDataset defaultcategorydataset = new DefaultCategoryDataset();
		defaultcategorydataset.addValue(23D, s, s1);
		defaultcategorydataset.addValue(14D, s, s2);
		defaultcategorydataset.addValue(51D, s, s3);
		defaultcategorydataset.addValue(25D, s, s4);
		defaultcategorydataset.addValue(5D, s, s5);
		defaultcategorydataset.addValue(32D, s, s6);
		defaultcategorydataset.addValue(17D, s, s7);
		defaultcategorydataset.addValue(13D, s, s8);
		return defaultcategorydataset;
	}
	...
	private static JFreeChart createChart() {
		...
		categoryplot.setDataset(2, createDataset3());
