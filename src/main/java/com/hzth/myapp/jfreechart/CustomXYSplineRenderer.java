...
public class CustomXYSplineRenderer extends XYLineAndShapeRenderer {

	private static final long serialVersionUID = -8783146234073022042L;
	 ...
	 */
	public CustomXYSplineRenderer(int precision) {
		super();
		if (precision <= 0) {
	...
	public boolean equals(Object obj) {
		...
		if (this.precision != that.getPrecision()) {
			return false;
		}
