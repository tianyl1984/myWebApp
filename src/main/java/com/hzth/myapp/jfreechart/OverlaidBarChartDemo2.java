...
public class OverlaidBarChartDemo2 extends ApplicationFrame {
	...
	public static JFreeChart createChart() {
		...
		IntervalMarker im = new IntervalMarker(10, 40, Color.red);
		categoryplot.addRangeMarker(im);
	...
	public static void main(String args[]) {
		OverlaidBarChartDemo2 overlaidbarchartdemo1 = new OverlaidBarChartDemo2("JFreeChart: OverlaidBarChartDemo2.java");
