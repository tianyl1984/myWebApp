...
public class FilterOut extends JFrame
{
	...
	public FilterOut(ArrayList<ResponseFilterAbstract> activeFilters)
	{
		...
		for (int i = 0; i < filterList.size(); i++)
		{
			try
			{
				String clsConfig = "com.hzth.myapp.myHttpClient.filter.response." + filterList.get(i) + "Config";
				String cls = "com.hzth.myapp.myHttpClient.filter.response." + filterList.get(i);
