...
package com.hzth.myapp.myHttpClient.filter.response;
...
public class Location extends ResponseFilterAbstract {
	...
	public void exec(Response response) throws Exception
	{
		...
		{
			com.hzth.myapp.myHttpClient.protocol.http.Response httpResponse = (com.hzth.myapp.myHttpClient.protocol.http.Response) response;
