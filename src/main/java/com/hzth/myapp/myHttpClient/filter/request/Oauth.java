...
import com.hzth.myapp.myHttpClient.filter.request.oauth.SignatureInterface;
...
public class Oauth extends RequestFilterAbstract
{
	public void exec(Request request) throws Exception
	{
		if (request instanceof com.hzth.myapp.myHttpClient.protocol.http.Request)
		{
			...
			String cls = "com.hzth.myapp.myHttpClient.filter.request.oauth." + this.resolveMethod(method);
