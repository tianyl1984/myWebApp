...
<%--     <%@ include file="/jqplot/jqplotHeader.jsp"%> --%>
	<script type="text/javascript">
		$(document).ready(function(){
			new html5jp.graph.vbar("chart6").draw([["分数",2,3,5,2,4,4.8]],{x:["","语文","数学","英语","物理","化学","生物"],y:["",2,4,6,8,9],yLabel:["层级A","层级B","层级C","层级D","层级AA"],yMax:9,yMin:0,barShape:"line",legend:false});
		});
  ...
  <body>
	...
	<div id="chart6" style="width: 400px;height: 300px">
