...
(function ($) {
	...
	<div class='pq-grid-footer'>&nbsp;</div>\
		...
		this.$cont.live("click", function (evt) {
...
//        }).mousedown(function(evt){});
		this.$cont.find("td.pq-grid-cell").live("click",function(evt){
			return that._onClickCell(evt); 
		}).mousedown(function(evt){});
...
//		});
		this.$cont.find("tr.pq-grid-row").live("click",function(evt){
			return that._onClickRow(evt); 
		});
...
//        });
		this.$cont.find("td.pq-grid-cell").live("dblclick",function(evt){
			return that._onDblClickCell(evt); 
		});
...
//			}
//        });
		this.$cont.find("td.pq-grid-cell").live("mouseenter",function(evt){
			var $td=$(this);
	        if(that._trigger("cellMouseEnter", evt, {
	            $td: $td,
				dataModel: that.options.dataModel
...
//        });
		...
		this.$cont.find("tr.pq-grid-row").live("mouseenter",function(evt){
			var $tr=$(this);
	        if(that._trigger("rowMouseEnter", evt, {
	            $tr: $tr,
				dataModel: that.options.dataModel
...
//			}
//        });
		this.$cont.find("td.pq-grid-cell").live("mouseleave",function(evt){
			var $td=$(this);
	        if(that._trigger("cellMouseLeave", evt, {
	            $td: $td,
				dataModel: that.options.dataModel
...
//			}
//        });
		this.$cont.find("tr.pq-grid-row").live("mouseleave",function(evt){
			var $tr=$(this);
	        if(that._trigger("rowMouseLeave", evt, {
	            $tr: $tr,
				dataModel: that.options.dataModel
